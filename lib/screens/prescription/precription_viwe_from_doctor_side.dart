...
class AllPrecriptionView extends StatefulWidget {
  Datum _datum;
  AllPrecriptionView(this._datum);
  @override
  _AllPrecriptionViewState createState() => _AllPrecriptionViewState();
}

class _AllPrecriptionViewState extends State<AllPrecriptionView> {
  var _isLoading = false;
  void initState() {
    // TODO: implement initState
    _isLoading = true;
    Provider.of<Prescription>(context, listen: false)
        .AllPrecriptionView(widget._datum.prescription)
        .then((_) {
      setState(() {
        _isLoading = false;
      });
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          widget._datum.patient.firstName,
                                          style: NormalText,
                                        ),
                                        Text(" "),
                                        Text(
                                          widget._datum.patient.lastName,
                                          style: NormalText,
                                        ),
                                      ],
                                    ),
                                    ...
                                    Container(
                                      ...
                                      color: Colors.white,
                                      child: ListView.builder(
                                        itemCount: snapshot.data.newPrescription
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  ...
                                                  bottom: 5),
                                              child: Text(
                                                snapshot.data.historyData[index]
                                                    .appointment.dayOfWeek,
                                                style: NormalText,
                                              ),
                                            ),
